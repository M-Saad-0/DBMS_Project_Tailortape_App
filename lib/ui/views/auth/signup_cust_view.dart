...
class SignUpCustView extends StatefulWidget {
  const SignUpCustView({super.key});

  @override
  State<SignUpCustView> createState() => _SignUpCustViewState();
}

class _SignUpCustViewState extends State<SignUpCustView> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TypeWriter(
                    controller: TypeWriterController(
                        text: "Sign up now as a Customer",
